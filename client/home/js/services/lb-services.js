  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.School#prototype$__get__address
        ...
        "prototype$__get__address": {
          url: urlBase + "/Schools/:id/address",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.School#prototype$__create__address
         * @methodOf lbServices.School
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.School#prototype$__update__address
         * @methodOf lbServices.School
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.School#prototype$__destroy__address
         * @methodOf lbServices.School
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.School#verifyEmail
         * @methodOf lbServices.School
         *
         * @description
         *
         ...
         */
        "verifyEmail": {
          url: urlBase + "/Schools/verify_email",
          method: "GET"
        },
      }
    );
